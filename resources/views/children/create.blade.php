...
<head>
    ...
    <title>Add Child - TitaClinic</title>
                    ...
                    <form method="POST" action="{{ route('children.store') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="patient_number" class="form-control" required value="{{ old('patient_number') }}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="current_medications" class="form-control" rows="2">{{ old('current_medications') }}</textarea>
                            </div>
                        </div>
                        @if ($errors->any())
                            <div class="alert alert-danger mt-3">{{ $errors->first() }}</div>
                        @endif
                        <button class="btn btn-primary mt-4">Save child</button>
                    </form>
                </div>
            </div>
        </div>
